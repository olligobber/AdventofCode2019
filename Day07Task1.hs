...
runOnPara code para input = head $ runforever $ makeState code [para, input]

runSequence :: [Int] -> (Int, Int, Int, Int, Int) -> Int
runSequence code (paraA, paraB, paraC, paraD, paraE) =
    r paraE . r paraD . r paraC . r paraB . r paraA $ 0
    where
        r x = runOnPara code x
